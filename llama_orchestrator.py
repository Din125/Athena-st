...
control_plane = ControlPlaneServer(
    ...
    orchestrator=AgentOrchestrator(llm=OpenAI(api_key=st.secrets["OPEN_AI_API_KEY"],model="gpt-4"))
)

def create_agent_service():
    agent = ReActAgent.from_tools([],llm=OpenAI(api_key=st.secrets["OPEN_AI_API_KEY"],model="gpt-4"))
